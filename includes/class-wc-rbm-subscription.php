...
class WC_RBM_Subscription {
    ...
    public function update_status($subscription_id, $new_status) {
        ...
        if ($new_status !== 'active' && function_exists('WC_RBM') && WC_RBM()->has_component('url_manager')) {
    ...
    public function delete($subscription_id) {
        ...
        try {
            ...
            $urls = $wpdb->get_results($wpdb->prepare(
                "SELECT url FROM {$tables['user_urls']} 
            ...
            if (!empty($urls) && function_exists('WC_RBM') && WC_RBM()->has_component('url_manager')) {
    ...
    public function get_statistics() {
        ...
        $stats['monthly_revenue'] = $wpdb->get_var(
            "SELECT SUM(amount) FROM {$tables['subscriptions']} 
